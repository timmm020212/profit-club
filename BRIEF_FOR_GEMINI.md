...
| Услуги | `/partner/services` | ✅ | CRUD услуг + варианты, загрузка фото в Supabase Storage. |
...
- **Склад / товары:** учёт расходников (краска, шампуни), товары на продажу.
