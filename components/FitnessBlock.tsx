...
export default function FitnessBlock() {
  ...
  return (
    <section className="relative w-full bg-white py-8 md:py-12 lg:py-16 overflow-visible">
      ...
      <div ref={containerRef} className="relative w-full h-[600px] md:h-[750px] lg:h-[900px] px-4 md:px-6 lg:px-8 overflow-visible">
        ...
        {/* Бежевый прямоугольник за картинкой - точно по её размеру, смещен на -100px по x и -100px по y */}
        {imageSize.width > 0 && imageSize.height > 0 && (
          <div 
            className="absolute bg-[#B8A693] z-0 pointer-events-none"
            style={{
      ...
      <div className="relative w-full bg-white py-8 md:py-10 lg:py-12">
